...
class WorkspaceBagger():
    ...
    def _set_bag_info(self, bag, total_bytes, total_files, ocrd_identifier, ocrd_base_version_checksum, ocrd_mets=DEFAULT_METS_BASENAME, tags={}):
        bag.info.update(tags)
    ...
    def bag(self,
        ...
        Arguments:
            ...
            bag_info_tags: Map with additional tags to add to bag-info.txt
        """
        ...
        # create bag-info.txt
        bag = Bag(bagdir)
        self._set_bag_info(bag, total_bytes, total_files, ocrd_identifier, ocrd_base_version_checksum, ocrd_mets=ocrd_mets, tags=bag_info_tags)
